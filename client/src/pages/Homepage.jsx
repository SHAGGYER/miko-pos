    ...
    <div style={{ width: "100%" }}>
      <section className="bg-gray-800 text-gray-100 py-16">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          <a
            href="#"
            className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full hover:bg-gray-300"
            role="alert"
          >
            <span className="text-xs bg-gray-600 rounded-full text-white px-4 py-1.5 mr-3">
              New
            </span>{" "}
          ...
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-200 md:text-5xl lg:text-6xl text-white">
            {APP_NAME}
          </h1>
          ...
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a
              href="#"
              className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-primary-300 focus:ring-primary-900"
            >
              Learn more
              <svg
            ...
            <a
              href="#"
              className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-200 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 text-white border-gray-700 hover:bg-gray-700 focus:ring-gray-800"
            >
              <svg
        ...
        <article className="max-w-2xl px-6 py-24 mx-auto space-y-12">
          <div className="w-full mx-auto space-y-4 text-center">
            ...
            <h1 className="text-4xl font-bold leading-tight md:text-5xl">
              A few words from the lead programmer and CEO
            </h1>
          </div>
          <div className="pt-12 border-t border-gray-700">
            <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
              <img
                src="https://nartoper.sirv.com/Images/mikolaj7.jpg"
                className="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start bg-gray-500 border-gray-700"
              />
              <div className="flex flex-col">
                <h4 className="text-lg font-semibold">Mikolaj Marciniak</h4>
                <p className="text-gray-400">
                  Hello, and thank you for checking out Miko POS! I really
                  appreciate your support and I hope that you will enjoy this
                  app. I will strive for making the app better!
                </p>
              </div>
            </div>
          </div>
      ...
      <Testimonial />
      <section>
        <div className="container flex gap-12 flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-center">
          ...
          <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            <h1 className="text-5xl font-bold leading-none sm:text-6xl">
              Ac mattis <span className="text-violet-400">senectus</span> erat
              pharetra
            </h1>
