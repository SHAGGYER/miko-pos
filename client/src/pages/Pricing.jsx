...
function Pricing(props) {
  return (
    <section className="bg-gray-800 text-gray-100 w-full p-8">
      <h1 className="text-[70px] text-center mb-8">Pricing</h1>
          ...
          <thead>
            <tr>
              ...
              <th scope="col">
                ...
                <p className="mb-3">
                  <span className="text-2xl font-bold sm:text-4xl text-gray-50">
                    0€
                  </span>
            ...
            <tr>
              ...
              <td>
                <svg
                  ...
                  className="w-5 h-5 mx-auto text-violet-400"
                >
                  <path
                    fillRule="evenodd"
