...
function Testimonial(props) {
  return (
    <section className="bg-gray-800 text-gray-300 py-32">
      <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
        ...
        <div className="flex justify-center space-x-3">
          <img
            ...
            alt=""
            className="w-20 h-20 bg-center bg-cover rounded-md bg-gray-500 bg-gray-200"
          />
          <div>
            ...
            <a
              className="flex items-center py-2 space-x-1 text-sm text-violet-400"
              href="/"
            >
